...
public class RecipesAdapter extends ArrayAdapter<String> {
    ...
    public RecipesAdapter(Context context, String[] programName, int[] images, String[] programDescription, String[] urls) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        RecipesViewHolder holder = null;

        if(singleItem == null){
            LayoutInflater layoutInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            singleItem = layoutInflater.inflate(R.layout.single_item, parent, false);
            holder = new RecipesViewHolder(singleItem);
            singleItem.setTag(holder);
        }
        else{
            holder = (RecipesViewHolder) singleItem.getTag();
        }
